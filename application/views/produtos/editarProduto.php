            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div style="display: flex; gap: 5px;">
                                <input id="codDeBarra" type="text" name="codDeBarra" value="<?php echo isset($result->codDeBarra) ? $result->codDeBarra : ''; ?>" tabindex="1" placeholder="Código de Barra" aria-label="Código de Barra" style="margin-bottom: 0;" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="descricao" type="text" name="descricao" maxlength="255" value="<?php echo isset($result->descricao) ? $result->descricao : ''; ?>" tabindex="3" placeholder="Descrição do produto" aria-label="Descrição do produto" aria-required="true" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label for="entrada" class="btn btn-default" style="margin-top: 5px;">Entrada
                                <input type="checkbox" id="entrada" name="entrada" class="badgebox" value="1" <?= (isset($result->entrada) && $result->entrada == 1) ? 'checked' : '' ?> tabindex="4" aria-label="Tipo de Movimento: Entrada">
                                <span class="badge">&check;</span>
                            </label>
                            <label for="saida" class="btn btn-default" style="margin-top: 5px;">Saída
                                <input type="checkbox" id="saida" name="saida" class="badgebox" value="1" <?= (isset($result->saida) && $result->saida == 1) ? 'checked' : '' ?> tabindex="5" aria-label="Tipo de Movimento: Saída">
                                <span class="badge">&check;</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoCompra" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="precoCompra" value="<?php echo isset($result->precoCompra) ? $result->precoCompra : ''; ?>" tabindex="6" placeholder="0.00" aria-label="Preço de Compra" aria-required="true" />
                            Margem <input style="width: 3em;" id="margemLucro" name="margemLucro" type="text" placeholder="%" maxlength="3" size="2" tabindex="7" aria-label="Margem de Lucro" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="selectLucro" name="selectLucro" style="width: 10.5em;" tabindex="8" aria-label="Tipo de Lucro">
                              <option value="markup">Markup</option>
                              <option value="margemLucro">Margem de Lucro</option>
                            </select>
                            <input style="width: 4em;" id="Lucro" name="Lucro" type="text" placeholder="%" maxlength="3" size="2" tabindex="9" aria-label="Porcentagem de Lucro" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoVenda" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="precoVenda" value="<?php echo isset($result->precoVenda) ? $result->precoVenda : ''; ?>" tabindex="10" placeholder="0.00" aria-label="Preço de Venda" aria-required="true" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="unidade" name="unidade" style="width: 15em;" tabindex="11" aria-label="Unidade de medida" aria-required="true"></select>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="estoque" type="text" name="estoque" value="<?php echo isset($result->estoque) ? $result->estoque : ''; ?>" tabindex="12" placeholder="0" aria-label="Quantidade em estoque" aria-required="true" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="estoqueMinimo" type="text" name="estoqueMinimo" value="<?php echo isset($result->estoqueMinimo) ? $result->estoqueMinimo : ''; ?>" tabindex="13" placeholder="0" aria-label="Estoque Mínimo" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="url_pagina" type="text" name="url_pagina" value="<?php echo isset($result->url_pagina) ? $result->url_pagina : ''; ?>" tabindex="14" placeholder="https://..." aria-label="Página do Produto (URL)" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="url_especificacoes" type="text" name="url_especificacoes" value="<?php echo isset($result->url_especificacoes) ? $result->url_especificacoes : ''; ?>" tabindex="15" placeholder="https://..." aria-label="Especificações (URL)" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="ncm" type="text" name="ncm" value="<?php echo isset($result->ncm) ? $result->ncm : ''; ?>" placeholder="Ex: 84713012" maxlength="8" tabindex="16" aria-label="NCM" aria-required="true" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="cest" type="text" name="cest" value="<?php echo isset($result->cest) ? $result->cest : ''; ?>" placeholder="Ex: 21.040.00" maxlength="9" tabindex="17" aria-label="CEST" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="origem" name="origem" tabindex="18" aria-label="Origem do produto">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="cst_csosn" name="cst_csosn" tabindex="19" aria-label="CST/CSOSN" aria-required="true">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="ibs_cbs" type="text" name="ibs_cbs" value="<?php echo isset($result->ibs_cbs) && !empty($result->ibs_cbs) ? $result->ibs_cbs : 'CBS: 0.90% | IBS: 0.10%'; ?>" tabindex="20" readonly aria-label="IBS/CBS" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="aliquota_icms" class="money" type="text" name="aliquota_icms" value="<?php echo set_value('aliquota_icms', isset($result->aliquota_icms) ? $result->aliquota_icms : ''); ?>" placeholder="Ex: 18.00" tabindex="21" aria-label="Alíquota ICMS" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label tabindex="22" id="add-image-button" for="userfile" class="button btn btn-mini btn-info"><span class="button__icon"><i class='bx bx-image-add'></i></span><span class="button__text2">Adicionar Imagens</span></label>
                    ...
                    <div class="control-group">
                        <label class="control-label">Pré-visualização (Novas Imagens)</label>
                        <div class="controls">
                                ...
                                <?php foreach ($images as $img) : ?>
                                    <li class="span2" id="img-<?php echo $img->idImagens; ?>">
                                        <div class="thumbnail img-container">
                                            <img src="<?php echo $img->thumb; ?>" alt="" style="height: 120px; width: 100%; object-fit: cover;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div style="display: flex; flex-direction: column; align-items: start;">
                                <?php if (isset($qrCode)) : echo $qrCode; endif; ?>
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3" style="display: flex;justify-content: center">
                                <button type="submit" class="button btn btn-primary" style="max-width: 160px" tabindex="23">
                                  <span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Atualizar</span></button>
                                <a href="<?php echo base_url() ?>index.php/produtos" id="" class="button btn btn-mini btn-warning" tabindex="24">
            ...
            reader.onload = function(event) {
                ...
                li.innerHTML = `
                    <div class="thumbnail img-container">
                        ...
                        <div class="img-main-label">
                             <input type="radio" name="temp_principal" class="set-principal tip-top" title="Marcar como Principal" value="${index}" ${currentPrincipal == index ? 'checked' : ''}>
                        </div>
                        <div class="img-controls">
                            <button type="button" class="btn btn-danger btn-mini remove-image tip-top" title="Remover da lista" data-index="${index}"><i class="bx bx-trash"></i></button>
                        </div>
                    </div>
                `;
